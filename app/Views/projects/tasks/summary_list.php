    ...
    $(document).ready(function () {
        $("#timesheet-summary-table").appTable({
            ...
            columns: [
                ...
                {title: "<?php echo get_setting("users_can_input_only_total_hours_instead_of_period") ? app_lang("date") : app_lang('init') ?>", "iDataSort": 4, order_by: "start_time"},
                {visible: false, searchable: false, order_by: "end_time"},
                {title: "<?php echo app_lang('conclusion') ?>", "iDataSort": 6, visible: true, order_by: "end_time"},

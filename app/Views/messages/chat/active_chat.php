        ...
        <div><?php
            ...
            if($message_info->group_name)
            {
                if(!empty($project_info)) {
                    ...
                    {
                        $link =  anchor(get_uri("projects/view/" . $message_info->project_id . "/ticket"), $ticket_icon . $message_info->group_name);
                    }
                    else
                    {
                        $link = anchor(get_uri("projects/view/" . $message_info->project_id), $project_icon . $message_info->group_name);
                    }
                } else {
                    ...
                    $link = $group_icon . $message_info->group_name;
                } 
                echo $link;
            }
            ?>

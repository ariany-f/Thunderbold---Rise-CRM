    ...
    $(document).ready(function () {
        ...
        $("#invoice-table").appTable({
            ...
            columns: [
                ...
                {visible: false, searchable: false},
                {title: "<?php echo app_lang("bill_date") ?>", "class": "w10p", visible: false, searchable: false},
                {visible: false, searchable: false},
                {title: "<?php echo app_lang("due_date") ?>", "class": "w10p", visible: false, searchable: false},
                {title: "<?php echo app_lang("nfe_number") ?>", "class": "w10p text-right"},

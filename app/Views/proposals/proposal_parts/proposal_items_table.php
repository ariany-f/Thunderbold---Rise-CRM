...
<table class="table-responsive" style="width: 100%; color: #444;">            
    <tr style="font-weight: bold; background-color: <?php echo $color; ?>; color: #fff;  ">
        ...
        <th colspan="2" style="text-align: center;  width: 15%; border-right: 1px solid #eee;"> <?php echo app_lang("quantity"); ?></th>
    ...
    foreach ($proposal_items as $item) {
        ...
        <tr style="background-color: #f4f4f4; ">
            ...
            <td colspan="2" style="text-align: center; width: 15%; border: 1px solid #fff;"> <?php echo $item->quantity + $item->quantity_gp  . " " . $item->unit_type; ?></td>

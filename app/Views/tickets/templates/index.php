    ...
    <ul class="nav nav-tabs bg-white title" role="tablist">
        ...
        <div class="tab-title clearfix no-border">
            <div class="title-button-group">
                <?php echo modal_anchor(get_uri("tickets/ticket_template_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_template'), array("class" => "btn btn-success", "title" => app_lang('add_template'))); ?>
            </div>
        </div>

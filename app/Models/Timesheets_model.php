...
class Timesheets_model extends Crud_model {
    ...
    function get_summary_details($options = array()) {
        ...
        if ($group_by === "member") {
            ...
            $group_by_manager = "$project_resources_table.user_id";
            $group_by_general = "user_id";
        } else if ($group_by === "task") {
            $group_by_option = "$timesheet_table.task_id";
            $group_by_manager = "task_id";
            $group_by_general = "task_id";
        } else if ($group_by === "project") {
            $group_by_option = "$timesheet_table.project_id";
            $group_by_manager = "$project_resources_table.project_id";
            $group_by_general = "project_id";
        }

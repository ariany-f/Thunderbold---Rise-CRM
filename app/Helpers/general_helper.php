    ...
    function prepare_proposal_view($proposal_data) {
        if ($proposal_data) {
            ...
            foreach ($proposal_items as $item) {
                $total_quantity += $item->quantity + $item->quantity_gp + $item->quantity_qa + $item->quantity_add;
                $total_amount += $item->rate * ($item->quantity + $item->quantity_gp + $item->quantity_qa + $item->quantity_add);
